...
public class Signup extends JFrame implements ActionListener{
    ...
    Signup(){
        ...
        JLabel l4 = new JLabel("Create Account For");
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("waterbilling/img/signup.jpg"));
        ...
        if(ae.getSource() == b1){
            ...
            try{
                ...
                if(user.equals("Admin")){
                    str = "insert into login1 values('"+meter+"', '"+username+"', '"+name+"', '"+password+"', '"+user+"')";
                }else{
                    str = "update login1 set username = '"+username+"', name = '"+name+"', password = '"+password+"', user = '"+user+"' where meter_no = '"+t4.getText()+"'";
                }
