...
public class project extends JFrame implements ActionListener{
    ...
    project(String meter, String person){
        ...
        ImageIcon ic =  new ImageIcon(ClassLoader.getSystemResource("waterbilling/img/waterbg.jpg")); // bg image
        ...
        ImageIcon icon1 = new ImageIcon(ClassLoader.getSystemResource("waterbilling/img/icon1.png"));
        ...
        ImageIcon icon2 = new ImageIcon(ClassLoader.getSystemResource("waterbilling/img/watermeter.png"));
        ...
        ImageIcon icon3 = new ImageIcon(ClassLoader.getSystemResource("waterbilling/img/icon2.png"));
        ...
        ImageIcon icon5 = new ImageIcon(ClassLoader.getSystemResource("waterbilling/img/bill.jpg"));
        ...
        ImageIcon icon41 = new ImageIcon(ClassLoader.getSystemResource("waterbilling/img/pay.jpg"));
        ...
        ImageIcon icon42 = new ImageIcon(ClassLoader.getSystemResource("waterbilling/img/bill.jpg"));
        ...
        ImageIcon icon4 = new ImageIcon(ClassLoader.getSystemResource("waterbilling/img/icon4.png"));
        ...
        ImageIcon icon6 = new ImageIcon(ClassLoader.getSystemResource("waterbilling/img/icon6.jpg"));
        ...
        ImageIcon icon7 = new ImageIcon(ClassLoader.getSystemResource("waterbilling/img/icon7.png"));
        ...
        ImageIcon icon8 = new ImageIcon(ClassLoader.getSystemResource("waterbilling/img/icon12.png"));
        ...
        ImageIcon icon9 = new ImageIcon(ClassLoader.getSystemResource("waterbilling/img/calculator.png"));
        ...
        ImageIcon icon10 = new ImageIcon(ClassLoader.getSystemResource("waterbilling/img/icon10.jpg"));
        ...
        ImageIcon icon11 = new ImageIcon(ClassLoader.getSystemResource("waterbilling/img/cancel.jpg"));
